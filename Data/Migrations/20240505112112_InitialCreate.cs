    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1000, "Category1", 0.1m, 1, new DateTime(2024, 4, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6920), "Origin1", 49.99m, 100 },
                    { 2, 1200, "Category2", 0.05m, 2, new DateTime(2024, 4, 15, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6924), "Origin2", 39.99m, 150 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Country1", "studio1@example.com", new DateTime(2014, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6776), 1, "Studio1", "www.studio1.com" },
                    { 2, true, "Country2", "studio2@example.com", new DateTime(2019, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6814), 2, "Studio2", "www.studio2.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 30, "user1@example.com", 1, 1, "User1", "password1", new DateTime(2022, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6983), "admin", "Surname1" },
                    { 2, true, 25, "user2@example.com", 2, 2, "User2", "password2", new DateTime(2023, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6987), "admin", "Surname2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 100, "Community1", new DateTime(2023, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(7019), 1 },
                    { 2, true, 150, "Community2", new DateTime(2022, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(7023), 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6999), 1, 50, new DateTime(2024, 4, 28, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(7002), 4, 1 },
                    { 2, new DateTime(2024, 2, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(7005), 2, 100, new DateTime(2024, 4, 30, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(7007), 5, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(7036), 0m, 1 },
                    { 2, new DateTime(2024, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(7039), 0m, 2 }
                });

            migrationBuilder.InsertData(
                table: "Games",
                columns: new[] { "GameID", "Available", "Description", "LibraryGameUserId", "Name", "Price", "ReleaseDate", "ShoppingCartID", "StoreID", "StudioID" },
                values: new object[] { 1, true, "Description1", 1, "Game1", 59.99m, new DateTime(2023, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6965), null, 1, 1 });

            migrationBuilder.InsertData(
                table: "Games",
                columns: new[] { "GameID", "Available", "Description", "LibraryGameUserId", "Name", "Price", "ReleaseDate", "ShoppingCartID", "StoreID", "StudioID" },
                values: new object[] { 2, true, "Description2", 2, "Game2", 49.99m, new DateTime(2022, 5, 5, 13, 21, 11, 863, DateTimeKind.Local).AddTicks(6970), null, 2, 2 });
