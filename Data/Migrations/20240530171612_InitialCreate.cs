    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "Summer Discounts", new DateTime(2024, 4, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(3842), "Europe", 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Japan", "bandaisupport@gmail.com", "bandainamco@gmail.com", new DateTime(2014, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(3637), "Bandai Namco Entertainment", "Dq61uGd16mtsRoJ.", "www.bandai.com" },
                    { 2, "France", "ubisoftsupport@gmail.com", "ubisoft@gmail.com", new DateTime(2019, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(3671), "Ubisoft", "4F1Gb7P72SHlwos", "www.ubisoft.com" },
                    { 3, "Tokyo", "sonysupport@gmail.com", "sony@gmail.com", new DateTime(2019, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(3675), "Sony Interactive Entertainment", "7Z94eudXHZLVYYC", "www.sony.com" },
                    { 4, "USA", "activisionsupport@gmail.com", "activision@gmail.com", new DateTime(2019, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(3677), "Activision", "2z1K7Fjdno23one", "www.activision.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 30, "admin@gmail.com", 1, "userAdmin", "L4Mf13z1E7YsU7N", new DateTime(2022, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(3997), "admin", "surnameAdmin" },
                    { 2, 25, "user@gmail.com", 2, "userName", "R0f86GsPcN2tJQ3", new DateTime(2023, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4001), "user", "userSurname" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4014), 50, new DateTime(2024, 5, 23, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4017), 4, 1 },
                    { 2, new DateTime(2024, 2, 29, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4019), 100, new DateTime(2024, 5, 25, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4022), 5, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4054), 0m, 1 },
                    { 2, new DateTime(2024, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4057), 0m, 2 }
                });

            migrationBuilder.InsertData(
                table: "Communities",
                columns: new[] { "MessageID", "ActiveMember", "GameID", "LikesCount", "Message", "PublicationDate", "UserID" },
                values: new object[] { 1, true, 1, 100, "This game is amazing.", new DateTime(2023, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4038), 1 });

            migrationBuilder.InsertData(
                table: "Communities",
                columns: new[] { "MessageID", "ActiveMember", "GameID", "LikesCount", "Message", "PublicationDate", "UserID" },
                values: new object[] { 2, true, 1, 150, "I personally recommend this piece of art.", new DateTime(2022, 5, 30, 19, 16, 12, 180, DateTimeKind.Local).AddTicks(4042), 2 });
