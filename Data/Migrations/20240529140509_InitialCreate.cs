    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "Summer Discounts", new DateTime(2024, 4, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9452), "Europe", 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Japan", "bandaisupport@gmail.com", "bandainamco@gmail.com", new DateTime(2014, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9303), "Bandai Namco Entertainment", "Dq61uGd16mtsRoJ.", "www.bandai.com" },
                    { 2, "France", "ubisoftsupport@gmail.com", "ubisoft@gmail.com", new DateTime(2019, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9337), "Ubisoft", "4F1Gb7P72SHlwos", "www.ubisoft.com" },
                    { 3, "Tokyo", "sonysupport@gmail.com", "sony@gmail.com", new DateTime(2019, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9340), "Sony Interactive Entertainment", "7Z94eudXHZLVYYC", "www.sony.com" },
                    { 4, "USA", "activisionsupport@gmail.com", "activision@gmail.com", new DateTime(2019, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9343), "Activision", "2z1K7Fjdno23one", "www.activision.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 30, "admin@gmail.com", 1, "userAdmin", "L4Mf13z1E7YsU7N", new DateTime(2022, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9609), "admin", "surnameAdmin" },
                    { 2, 25, "user@gmail.com", 2, "userName", "R0f86GsPcN2tJQ3", new DateTime(2023, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9613), "user", "userSurname" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9624), 50, new DateTime(2024, 5, 22, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9627), 4, 1 },
                    { 2, new DateTime(2024, 2, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9630), 100, new DateTime(2024, 5, 24, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9632), 5, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9659), 0m, 1 },
                    { 2, new DateTime(2024, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9662), 0m, 2 }
                });

            migrationBuilder.InsertData(
                table: "Communities",
                columns: new[] { "MessageID", "ActiveMember", "GameID", "LikesCount", "Message", "PublicationDate", "UserID" },
                values: new object[] { 1, true, 1, 100, "This game is amazing.", new DateTime(2023, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9644), 1 });

            migrationBuilder.InsertData(
                table: "Communities",
                columns: new[] { "MessageID", "ActiveMember", "GameID", "LikesCount", "Message", "PublicationDate", "UserID" },
                values: new object[] { 2, true, 1, 150, "I personally recommend this piece of art.", new DateTime(2022, 5, 29, 16, 5, 8, 816, DateTimeKind.Local).AddTicks(9648), 2 });
